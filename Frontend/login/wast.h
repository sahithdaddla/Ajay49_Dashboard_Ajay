...
<body id="appBody" class="login-body">
  ...
  <div id="loginView" class="container">
    ...
    <div class="login-container">
      ...
      <div class="links">
        <a href="http://13.60.36.119:8013/">Sign Up</a> | <a href="http://13.60.36.119:8010">Forgot Password?</a>
      </div>
    </div>
  </div>
  ...
  <div id="dashboardView" class="hidden">
    ...
    <main class="main-content" id="mainContent">
      <iframe id="contentFrame" src="http://13.60.36.119:7999/" loading="lazy"></iframe>
    </main>
...
document.addEventListener('DOMContentLoaded', async () => {
  const config = {
    apiBaseUrl: 'http://13.60.36.119:3404/api',
    wsUrl: 'ws://13.60.36.119:4500',
    authUrls: {
      login: 'http://13.60.36.119:8012',
      signup: 'http://13.60.36.119:8013/',
      forgotPassword: 'http://13.60.36.119:8010'
    },
    modules: {
      emp_attendance: 'http://13.60.36.119:8051/',
      emp_leave: 'leave.html',
      emp_wfh: 'http://13.60.36.119:8025/',
      emp_payslip: 'http://3.85.61.23:7019/',
      emp_tasks: 'http://13.60.36.119:8045/',
      emp_helpdesk: 'http://13.60.36.119:8049/',
      emp_Onboarding: 'http://13.60.36.119:8039/',
      emp_benefits: 'http://13.60.36.119:8043/',
      emp_Appraisal: 'http://13.60.36.119:8014/',
      emp_notifications: 'http://13.60.36.119:8053/',
      emp_asset: 'http://13.60.36.119:8047/',
      emp_bonus: 'http://13.60.36.119:8055/',
      emp_joblists: 'http://3.85.61.23:8020/',
      emp_claim: 'http://13.60.36.119:8027/',
      emp_offboarding: 'http://13.60.36.119:8041/',
      emp_jobapplication: 'http://13.60.36.119:8031/',
      emp_offerletter: 'http://13.60.36.119:8033/',
      emp_logout: '',
      hr_attendance: 'http://13.60.36.119:8052/',
      hr_leave: 'leave.html',
      hr_wfh: 'http://13.60.36.119:8026/',
      hr_payslip: 'http://3.85.61.23:7020/',
      hr_tasks: 'http://13.60.36.119:8046/',
      hr_helpdesk: 'http://13.60.36.119:8050/',
      hr_Onboarding: 'http://13.60.36.119:8040/',
      hr_employeemanagement: 'http://13.60.36.119:8036/',
      hr_benefits: 'http://13.60.36.119:8044/',
      hr_appraisal: 'http://13.60.36.119:8015/',
      hr_notifications: 'http://13.60.36.119:8054/',
      hr_asset: 'http://13.60.36.119:8048/',
      hr_bonus: 'http://13.60.36.119:8056/',
      hr_joblists: 'http://3.85.61.23:8021/',
      hr_claim: 'http://13.60.36.119:8028/',
      hr_offboarding: 'http://13.60.36.119:8042/',
      hr_jobapplication: 'http://13.60.36.119:8032/',
      hr_logout: ''
    },
